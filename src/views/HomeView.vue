...
<template>
    <nav id="main-menu" class="md:w-3/5 w-2/3 md:py-0 py-10">
        <PageShortcut v-for="(shortcut, index) in shortcuts" :key="index" :shortcut="shortcut" />
    </nav>
</template>

<style lang="css" scoped>
    @import "@/assets/css/home/main-menu.css";
</style>