<script setup lang="ts">
    ...
    import type { ObservableCarousel } from '@/assets/ts/archive/carousels/observableCarousel';
    import { ElementObserver } from '@/assets/ts/archive/observation/elementObserver';
    import ObservableCarouselSlide from '../Archive/ObservableCarouselSlide.vue';
